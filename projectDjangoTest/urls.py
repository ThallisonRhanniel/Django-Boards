"""projectDjangoTest URL Configuration
...
urlpatterns = (
    ...
    url(r'^boards/(?P<pk>\d+)/$', views.TopicListView.as_view(), name='board_topics'), #url(r'^boards/(?P<pk>\d+)/$', views.board_topics, name='board_topics'),
    ...
    #url(r'^change-password/$', auth_views.password_reset, name='password_reset'),
